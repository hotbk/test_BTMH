...
with src as (
	...
	select
		'NY' as Ma_vung,
		concat('NY', '|', cast(dh.ID as string)) as ID_Key,
		dh.*
	from (
...
h as (
	select *
	from `btmh-airflow-dbt-lab-2026`.`stg_augges_225`.`dmh`
),
...
vbtg as (
	select *
	from `btmh-airflow-dbt-lab-2026`.`stg_augges_225`.`dmvbtg`
),

qttg as (
	select *
	from `btmh-airflow-dbt-lab-2026`.`stg_augges_225`.`dmqttg`
),

dth as (
	select *
	from `btmh-airflow-dbt-lab-2026`.`stg_augges_225`.`dmdt`
),
...
tt as (
	select
		Ty_Gia
	from `btmh-airflow-dbt-lab-2026`.`stg_augges_225`.`dmtt`
	where Ma_Tt = 'USD'
...
select
	...
	case
		...
		when (
			substr(Ma_Nhom, 1, 7) in ('BTCHV10', 'BTBTV10', 'BTMAV10', 'BTLTV10')
			or ((substr(Ma_Nhom, 1, 3) = 'BTD') and (substr(Ma_Nhom, -3, 3) = 'V10'))
			or ((substr(Ma_Nhom, 1, 3) = 'BTN') and (substr(Ma_Nhom, -3, 3) = 'V10'))
		) then 'BST'
...
from calc
	...
	select
		'SX' as Ma_vung,
		concat('SX', '|', cast(dh.ID as string)) as ID_Key,
		dh.*
	from (
...
h as (
	select *
	from `btmh-airflow-dbt-lab-2026`.`stg_augges_224`.`dmh`
),

nmm as (
	select *
	from `btmh-airflow-dbt-lab-2026`.`stg_augges_224`.`dmnmm`
),

nh as (
	select *
	from `btmh-airflow-dbt-lab-2026`.`stg_augges_224`.`dmnh`
),

vbmm as (
	select *
	from `btmh-airflow-dbt-lab-2026`.`stg_augges_224`.`dmvbmm`
),
...
vbtg as (
	select *
	from `btmh-airflow-dbt-lab-2026`.`stg_augges_224`.`dmvbtg`
),

qttg as (
	select *
	from `btmh-airflow-dbt-lab-2026`.`stg_augges_224`.`dmqttg`
),

dth as (
	select *
	from `btmh-airflow-dbt-lab-2026`.`stg_augges_224`.`dmdt`
),
...
tt as (
	select
		Ty_Gia
	from `btmh-airflow-dbt-lab-2026`.`stg_augges_224`.`dmtt`
	where Ma_Tt = 'USD'
	qualify row_number() over (order by Ma_Tt) = 1
),
...
from calc
	...
	select
		'HD' as Ma_vung,
		concat('HD', '|', cast(dh.ID as string)) as ID_Key,
		dh.*
	from (
...
h as (
	select *
	from `btmh-airflow-dbt-lab-2026`.`stg_augges_226`.`dmh`
),

nmm as (
	select *
	from `btmh-airflow-dbt-lab-2026`.`stg_augges_226`.`dmnmm`
),

nh as (
	select *
	from `btmh-airflow-dbt-lab-2026`.`stg_augges_226`.`dmnh`
),

vbmm as (
	select *
	from `btmh-airflow-dbt-lab-2026`.`stg_augges_226`.`dmvbmm`
),
...
vbtg as (
	select *
	from `btmh-airflow-dbt-lab-2026`.`stg_augges_226`.`dmvbtg`
),

qttg as (
	select *
	from `btmh-airflow-dbt-lab-2026`.`stg_augges_226`.`dmqttg`
),

dth as (
	select *
	from `btmh-airflow-dbt-lab-2026`.`stg_augges_226`.`dmdt`
),
...
tt as (
	select
		Ty_Gia
	from `btmh-airflow-dbt-lab-2026`.`stg_augges_226`.`dmtt`
	where Ma_Tt = 'USD'
	qualify row_number() over (order by Ma_Tt) = 1
),
...
from calc
	...
	select
		'BN' as Ma_vung,
		concat('BN', '|', cast(dh.ID as string)) as ID_Key,
		dh.*
	from (
...
h as (
	select *
	from `btmh-airflow-dbt-lab-2026`.`stg_augges_227`.`dmh`
),

nmm as (
	select *
	from `btmh-airflow-dbt-lab-2026`.`stg_augges_227`.`dmnmm`
),

nh as (
	select *
	from `btmh-airflow-dbt-lab-2026`.`stg_augges_227`.`dmnh`
),

vbmm as (
	select *
	from `btmh-airflow-dbt-lab-2026`.`stg_augges_227`.`dmvbmm`
),
...
vbtg as (
	select *
	from `btmh-airflow-dbt-lab-2026`.`stg_augges_227`.`dmvbtg`
),

qttg as (
	select *
	from `btmh-airflow-dbt-lab-2026`.`stg_augges_227`.`dmqttg`
),

dth as (
	select *
	from `btmh-airflow-dbt-lab-2026`.`stg_augges_227`.`dmdt`
),
...
tt as (
	select
		Ty_Gia
	from `btmh-airflow-dbt-lab-2026`.`stg_augges_227`.`dmtt`
	where Ma_Tt = 'USD'
	qualify row_number() over (order by Ma_Tt) = 1
),
...
from calc
	...
	select
		'SG' as Ma_vung,
		concat('SG', '|', cast(dh.ID as string)) as ID_Key,
		dh.*
	from (
...
h as (
	select *
	from `btmh-airflow-dbt-lab-2026`.`stg_augges_sg`.`dmh`
),

nmm as (
	select *
	from `btmh-airflow-dbt-lab-2026`.`stg_augges_sg`.`dmnmm`
),

nh as (
	select *
	from `btmh-airflow-dbt-lab-2026`.`stg_augges_sg`.`dmnh`
),

vbmm as (
	select *
	from `btmh-airflow-dbt-lab-2026`.`stg_augges_sg`.`dmvbmm`
),
...
vbtg as (
	select *
	from `btmh-airflow-dbt-lab-2026`.`stg_augges_sg`.`dmvbtg`
),

qttg as (
	select *
	from `btmh-airflow-dbt-lab-2026`.`stg_augges_sg`.`dmqttg`
),

dth as (
	select *
	from `btmh-airflow-dbt-lab-2026`.`stg_augges_sg`.`dmdt`
),
...
tt as (
	select
		Ty_Gia
	from `btmh-airflow-dbt-lab-2026`.`stg_augges_sg`.`dmtt`
	where Ma_Tt = 'USD'
	qualify row_number() over (order by Ma_Tt) = 1
),
