...
h as (select * from `btmh-airflow-dbt-lab-2026`.`btmh_dwh_dim`.`d_hang`),
nh as (select * from `btmh-airflow-dbt-lab-2026`.`btmh_dwh_dim`.`d_nhom`),
nmm as (select * from `btmh-airflow-dbt-lab-2026`.`btmh_dwh_dim`.`d_nhom_ma_mau`),
kho as (select * from `btmh-airflow-dbt-lab-2026`.`btmh_dwh_dim`.`d_kho`),
dt as (select * from `btmh-airflow-dbt-lab-2026`.`btmh_dwh_dim`.`d_doi_tac`),
nv as (select * from `btmh-airflow-dbt-lab-2026`.`btmh_dwh_dim`.`d_nhan_vien`),
dvt as (select * from `btmh-airflow-dbt-lab-2026`.`btmh_dwh_dim`.`d_dvt`),
...
old_rows as (
		...
		from `btmh-airflow-dbt-lab-2026`.`{{ env_var('ggs_bq_dataset', 'btmh_stg_ggs') }}`.`xlsx_doanh_thu_cu` as xlsx
		left join `btmh-airflow-dbt-lab-2026`.`btmh_dwh_dim`.`d_hang` as h_map
