...
from `btmh-airflow-dbt-lab-2026`.`btmh_dwh_fact`.`f_nhap_xuat` nx left join `btmh-airflow-dbt-lab-2026`.`btmh_dwh_dim`.`d_hach_toan` dnx on nx.ID_Nx = dnx.ID and nx.nguon = dnx.nguon
where 1=1
and id_dv >= 0
